...
public class CompareAccountUsageCSV {
	...
	public static void main(String[] args) throws Exception {
		...
		HashMap<String, Double> oldUsage = getHashMapFromFile("Usage_" + month + "_2019_Old.csv");

		HashMap<String, Double> newUsage = getHashMapFromFile("Usage_" + month + "_2019_New.csv");
	...
	public static HashMap<String, Double> getHashMapFromFile(String fileName) {
		...
		try {
			...
			while (line != null) {
				...
				Double monthlyCharge = new Double(DECIMAL_FORMAT.format(new Double(values[16])));
